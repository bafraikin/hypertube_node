<template>
  <div>
    <v-form ref="form" v-model="valid" :lazy-validation="lazy">
      ...
      <v-btn :disabled="!valid" color="success" class="mr-4" @click="requestForm">Validate</v-btn>
      <v-btn :disabled="!valid" color="success" class="mr-4" @click="requestPassword">Forgot Password</v-btn>
    </v-form>
    <oauth></oauth>
  </div>
</template>
